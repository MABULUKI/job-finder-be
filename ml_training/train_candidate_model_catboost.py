"""
Train a CatBoost model for candidate (seeker) recommendation using the generated CSV.
...
DATA_PATH = "data/candidate_recommendation_training.csv"
MODEL_PATH = "models/candidate_recommendation_model.cbm"
