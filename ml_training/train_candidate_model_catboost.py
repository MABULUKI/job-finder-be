...
df = pd.read_csv('candidate_recommendation_dataset.csv')
...
print(f'CatBoost Candidate Recommendation Validation AUC: {auc:.4f}')
model.save_model('candidate_catboost_model.cbm')
print('Model saved to candidate_catboost_model.cbm')
